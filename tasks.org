...
* STRT updated tasks and how to implement algorithm
* TODO #graph-service collapse all edges/markets/ to 'best value' bids & asks
best value for Asks -> lower is better
best value for Bids => higher is better
* TODO #graph-service implement correct edge direction
Exmple for BTCETH
Asks BTC->ETH
Bids BTC<-ETH
* TODO #graph-service calculate edge weight as negative ln
