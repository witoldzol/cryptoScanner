...
function formatData(data: object[]){
	...
	let formattedDataWithUpdatedKeys = util.updateObjectKeys(formattedData, 'XBT', 'BTC')
	let wrapper = util.wrapDataInObjectWithMarketName(formattedDataWithUpdatedKeys, this.marketName)
